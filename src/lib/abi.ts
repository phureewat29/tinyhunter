...
export const MEV_SHARE_CTF_MAGIC_NUMBER_V1 = [
  {
    inputs: [
      {
        internalType: 'contract MevShareCaptureLogger',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_magicNumber', type: 'uint256' },
    ],
...
export const MEV_SHARE_CTF_MAGIC_NUMBER_V2 = [
  {
    inputs: [
      {
        internalType: 'contract MevShareCaptureLogger',
...
export const MEV_SHARE_CTF_MAGIC_NUMBER_V3 = [
  {
    inputs: [
      {
        internalType: 'contract MevShareCaptureLogger',
...
export const MEV_SHARE_CTF_NEW_CONTRACT = [
  {
    inputs: [
      {
        internalType: 'contract MevShareCaptureLogger',
...
export const MEV_SHARE_CTF_TRIPLE = [
  {
    inputs: [
      {
        internalType: 'contract MevShareCaptureLogger',
